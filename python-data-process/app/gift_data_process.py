...
class GiftDataProcess:
    def __init__(self):
        self.spark = SparkSession.builder \
            .appName("GiftDataProcess") \
        ...
        self.extra_kafka_configs = {
            'subscribe': 'gift_topic',
            'kafka.group.id': 'gift_consumer',
        }

        self.extra_es_configs = {
            'es.resource': 'gift_data/_doc'
        }

        self.schema = StructType().add("timestamp", StringType()) \
            .add("event", StringType()) \
            .add("user_name", StringType()) \
            .add("gift_name", StringType()) \
            .add("combo_count", StringType())
