...
class SocialDataProcess:
    def __init__(self):
        self.spark = SparkSession.builder \
            .appName("SocialDataProcess") \
        ...
        self.extra_kafka_configs = {
            'subscribe': 'social_topic',
            'kafka.group.id': 'social_consumer',
        }

        self.extra_es_configs = {
            'es.resource': 'social_data/_doc'
        }
